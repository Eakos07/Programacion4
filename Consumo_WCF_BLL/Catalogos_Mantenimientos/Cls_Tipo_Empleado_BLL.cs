...
{
    public class Cls_Tipo_Empleado_BLL
    {
        public DataTable Listar(string sfiltro, ref string smsError)
        {
            ...
            {
                DT = Obj_Servicio.FiltrarDatos("SP_FILTRAR_TIPO_EMPLEADO", "@Nombre",
                    SqlDbType.NVarChar, sfiltro.Trim(), ref smsError);
            }
            else
            {
                DT = Obj_Servicio.ListarDatos("SP_FILTRAR_TIPO_EMPLEADO", ref smsError);
            }
