    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 bg-secondary text-white">
                ...
                <div class="form-group">
                    <asp:Button ID="btn_productos_filtrar" CssClass="btn boton" Text="Filtrar" OnClick="btn_productos_filtrar_Click" runat="server"/>
                </div>
                <hr />
                <div class="form-group">
                    <asp:Button ID="btn_productos_buscar" CssClass="btn boton" Text="Mostrar todos" runat="server" OnClick="btn_productos_buscar_Click" />
                </div>
            </div>
